...
SECRET_KEY = 'django-insecure-+&5wzu^+)28)8yvs_(2s$iyw+ws_627k_7gc*s!hr#$&r4)hzj'
...
# specifies the database ID of the Site object
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Blog API',
    'DESCRIPTION': 'a simple blog API with django',
    'VERSION': '1.0.0',
}